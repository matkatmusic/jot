...
- "## Recent Conversation" is always provided — do NOT attempt to Read the ${TRANSCRIPT_PATH} file yourself; the launcher has already extracted the relevant window.
